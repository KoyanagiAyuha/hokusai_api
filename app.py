...
def main(tmpinput, tmpoutput, style_num):
    style = ['wave', 'scream', 'la_muse', 'rain_princess', 'udnie', 'wreck']
    parser = build_parser()
    opts = parser.parse_args()
    opts.checkpoint_dir = "check_points/" + style[style_num] + ".ckpt"
    opts.in_path = tmpinput
    opts.out_path = tmpoutput
    check_opts(opts)
